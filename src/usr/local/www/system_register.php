...
$pghelp_ok = gettext('FreeSense<sup>&reg;</sup> Community Edition software may be upgraded to FreeSense<sup>&reg;</sup> Plus software by purchasing an upgrade from the Netgate store here: ' .
...
'<br /><br>Registration ensures you have access to the services included with FreeSense<sup>&reg;</sup> Plus software.' .
...
$pghelp_success = gettext("Your firewall has been successfully registered. On your next visit to the System/Update page, select FreeSense<sup>&reg;</sup> Plus software from the list of repositories.");
