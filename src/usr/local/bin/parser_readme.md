# FreeSense-dhcpv6-gui-leases-patch
...
'php -f' is optional on a FreeSense system.
...
DHCPv6 Status Leases page of FreeSense.
...
To parse an ISC DHCPv6 lease file (as used by FreeSense) call e.g.:<br/>
<pre>php -f parser_dhcpv6_leases_tester.php &lt;file&gt;</pre>

#### Running on a FreeSense system
* 'php -f' is optional on a FreeSense system.
* &lt;file&gt; is optional on a FreeSense system.<br/>
...
#### Running on a non-FreeSense system
* &lt;file&gt; is required.
* No NDP data is used.
...
own and peer status. That means there are two DHCP servers/FreeSenses sharing a
...
## Defect reports
https://github.com/FreeSense-org/freesense/issues
